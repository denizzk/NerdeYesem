...
import com.karakaya.deniz.nerdeyesem.helper.FingerprintHandler;
...
public class FingerprintActivity extends AppCompatActivity {
    ...
    private static final String KEY_NAME = "FingerprintActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.karakaya.deniz.nerdeyesem.R.layout.activity_fingerprint);

        fingerPrint = findViewById(com.karakaya.deniz.nerdeyesem.R.id.imageFinger);
        ...
        if (!fingerprintManager.isHardwareDetected())
            Toast.makeText(this, "Fingerprint authentication permission not enable", Toast
                    .LENGTH_SHORT).show();
        else {
            if (!fingerprintManager.hasEnrolledFingerprints())
                Toast.makeText(this, "Register at least one fingerprint in Settings", Toast
                        .LENGTH_SHORT).show();
            else {
                if (!keyguardManager.isKeyguardSecure())
                    Toast.makeText(this, "Lock screen security not enabled in Settings", Toast
                            .LENGTH_SHORT).show();
                else
                    genKey();
